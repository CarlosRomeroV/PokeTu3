...
function Login() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try{
      await loginUser(form.name, form.password)
  ...
  return (
    <form className="max-w-sm mx-auto min-w-sm" onSubmit={handleSubmit}>
      <div className="mb-5">
        ...
        <input name="name" value={form.name} onChange={handleChange} id="name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Nombre de usuario" required />
      </div>
      <div className="mb-5">
